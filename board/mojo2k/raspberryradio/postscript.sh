...
${BR_ROOT}/output/build/uboot-rpi_dev/tools/mkimage -C none -A arm -T script -d ${BR_ROOT}/board/mojo2k/raspberryradio/boot/boot.cmd ${TARGET}/../images/rpi-firmware/boot.scr
...
echo "/dev/mmcblk0p3	/sdcard	ext4	rw,auto	0	0" >> ${TARGET}/etc/fstab
